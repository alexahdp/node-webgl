...
module.exports = function () {
    ...
    platform = {
        ...
        createElement: function (name, width, height, fullScreen) {
        ...
        reinitWindow() {
            var w1 = ww;
            this.createWindow({width: 800, height: 800, fullScreen: true});
            //GLFW.DestroyWindow(w1);
        },
        ...
        createWindow: function (opts) {
            ...
            if (opts.fullScreen) {
                var m = GLFW.GetMonitors()[0];
                var maxResolution = m.modes[m.modes.length - 1];
            ...
            if (opts.fullScreen) {
                window = GLFW.CreateWindow(width, height, 'Title', m);
            } else {
